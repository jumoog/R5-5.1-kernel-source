...
/*OPPO zengling.wu@EXP.BasicDrv.Audio 2015-12-30  Delete for big current*/
#ifndef VENDOR_EDIT
static bool quat_enable_mclk;
#endif
/*OPPO zengling.wu@EXP.BasicDrv.Audio 2015-12-30 Delete end*/
...
static int msm8939_asoc_machine_probe(struct platform_device *pdev)
{
	...
	const char *ptr = NULL;//ADD BY STIVIE
	int num_strings = 0;
	int ret, i;
