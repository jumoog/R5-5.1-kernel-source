...
#define STK3X1X_EX_ALSPS_DYNAMIC_THRESHOLD
#endif /*VENDOR_EDIT*/

#ifdef STK3X1X_EX_ALSPS_DYNAMIC_THRESHOLD
static int ps_min = 0;
...
#endif /*STK3X1X_EX_ALSPS_DYNAMIC_THRESHOLD*/
...
#ifdef STK3X1X_EX_ALSPS_DYNAMIC_THRESHOLD    // Do not modify it as wilful, because it is used for algo.
                        ...
                        const struct i2c_device_id *id)
{
    ...
    printk(KERN_INFO "%s ex: driver version = %s\n", __func__, DRIVER_VERSION);
